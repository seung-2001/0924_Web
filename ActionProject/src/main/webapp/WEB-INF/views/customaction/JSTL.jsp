...
<body>
	...
	<h5>변수(사실 변수 아님 속성선언하기 == Attribute)</h5>
	...
	<pre>
		* 속성 출력(&lt;c:out value="출력할값" default="기본값" escapeXml="true/false"/>)
	...
	<c:set var="outStr" value="<strong>강한 정보</strong>" />
	<br>
	${ outStr } <br>
	<c:out value="${ outStr }" />
	&lt;strong>강한정보&lt;/</strong>
	...
	<pre>
		...
		- Java의 if-esle문, switch문 비슷한 역할을 하는 태그
