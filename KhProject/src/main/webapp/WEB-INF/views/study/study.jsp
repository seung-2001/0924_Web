...
<body>
	...
	<pre>
		...
		진짜로 자바스크립트 객체 XXXXXXXXXXXXX 자바스크립트 객체 모양으로 문자열을 만든거
		
		문법이 아주 업격함!!! 자바스크립트 객체
		{
	...
	<pre>
		...
		* 주요 속성
		...
		- type : 요청 전송방식(GET/POST... FETCH, PUT, DELETE, OPTION...)
				=> form태그의 method속성
		- data : 요청 시 전달값({키 : 벨류, 키 : 벨류}) => form태그의 input요소 value값
		- success : 통신 성공 시 실행할 콜백함수를 정의
		-----------------------------------------------------------------------
		- error : 통신 실패 시 실행할 콜백함수를 저으이
	...
	아이디 입력 : <input type="text" id="search-id" /> <br>
