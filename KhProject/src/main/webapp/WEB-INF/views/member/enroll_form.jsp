...
<body>
	...
	<script>
		function idCheck() {
			...
			// 아이디 중복체크 구현하기
			// 사용자가 입력한 아이디 값이 있어야함
			
			const $userId = $("#user_id").val();
			// console.log($userId);
			// 사용자가 입력한 아이디값이 5글자 이상일 때만 중복검사
			...
			<table
				...
				<tr>
					<td><input type="text" name="userId" id="user_id"
						...
						placeholder="숫자와 영어로 4-30자" onkeyup="idCheck();"></td>
				</tr>
				<tr>
					<td style="text-align: left">
						<p>
				...
				<tr>
					<td><input type="password" size="17" maxlength="30"
						id="password" name="userPwd" class="form-control tooltipstered"
