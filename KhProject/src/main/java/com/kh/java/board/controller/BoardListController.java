...
public class BoardListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		int pageLimit; // 페이지 하단에 페이징 버튼 개수 => 5개
		 ...
		 * 
		 * - 공식구하기 단, boardLimit이 10이라고 가정
		 * 
		 * 총 개수 한페이지 나눗셈 결과 마지막페이지 100 / 10 = 10.0 10 107 / 10 = 10.7 11 111 / 10 = 11.1
		 * 12
		 * 
		 * => 나눗셈(listCount/boardCount)의 결과를 올림처리 할경우 maxPage가 나옴
		 * 
		 * 스텝 1. listCount를 double로 변환 2. listCount / boardLimit 3. 결과를 올림처리 =>
		 * Math.ceil()
		 */
		 ...
		 * 
		 * currentPage startPage 1 1 5 1 10 1 11 11 13 11 17 11 20 11 21 21 30 21
		 * 
		 * 1 ~ 10 / 10 => 0 ~ 1 11 ~ 20 / 10 => 1 ~ 2 21 ~ 30 / 10 => 2 ~ 3
		 * 
		 * 0 ~ 9 / 10 => 0 10 ~ 19 / 10 => 1 20 ~ 29 / 10 => 2
		 * 
		...
		/*
		 * startPage, pageLimit에 영향을 받음 (maxPage도 영향을 끼침)
		 * 
		 * - 공식을 생각해보자 단, pageLimit이 10이라는 가정
		 * 
		 * startPage : 1 => endPage : 10 startPage : 21 => endPage : 30
		 * 
