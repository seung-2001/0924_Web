...
public class BoardListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// => BOARD 테이블에서 COUNT(*) (STATUS='Y' AND BOARD_TYPE = 1)
		...
		/*
		 * 스텝 1 1. lisctCount를 double로 변환 2. listCount / boardLimit 3. 결과를 올림처리 =>
		 * Math.ceil()
		 */
		...
		// * endPage : 페이지 하단에 보여질 페이지의 버튼의 끝 수
		/*
