...
public class BoardInsertController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (ServletFileUpload.isMultipartContent(request)) {
			 ...
			 * 단위 정리
			 * 
			 * bit X 8 => Byte => KByte => MByte => GByte => PByte => ...
			 * 
			 * 10MegaByte
			 * 
			 */
			...
			// a.jpg a2.jpg a3.jpg
			/*
			 * HttpServletRequest => MultipartRequest객체로 변환
			 * 
			 * [ 표현법 ] MultipartRequest multiRequest = new MultiRequest(request, 저장경로, 용량제한,
			 * 인코딩, 파일명을 수정해주는 객체);
			 * 
			 ...
			 * 
			 * Q) 파일명 왜 바꾸나요? A) 똑같은 파일명 있을 수 있으니까 파일명에 한글 / 특수문자 / 공백문자 포함경우 서버에 따라 문제가 발생
			 */
